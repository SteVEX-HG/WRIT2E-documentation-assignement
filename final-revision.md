...
> [!Note]
> This tutorial is only intended for ***64-bit*** machines running the ***Windows 10*** operating system, as C++ development environments varies significantly across different operating systems. 
